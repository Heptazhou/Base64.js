...
if (NODE_JS) {
	...
	btoa = (str) => new Buffer(str, "ascii").toString("base64")
	utf8Base64Encode = (str) => new Buffer(str).toString("base64")
	encodeFromBytes = utf8Base64Encode
	atob = (base64Str) => new Buffer(base64Str, "base64").toString("ascii")
	utf8Base64Decode = (base64Str) => new Buffer(base64Str, "base64").toString()
} else if (!btoa) {
	btoa = function (str) {
		var v1,
			v2,
